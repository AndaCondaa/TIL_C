...
int main()
{
	...
	else if (grade == 'C') printf("Usually");
	else if (grade == 'D') printf("Effort");
	else if (grade == 'F') printf("Failure");
	else printf("error");
...
int main()
{
	...
	while (true)
	{
		printf("number? ");
		scanf("%d", &input);
		if (input > 0) printf("positive integer\n");
		else if (input < 0) printf("negative number\n");
		else return 0;
	}
